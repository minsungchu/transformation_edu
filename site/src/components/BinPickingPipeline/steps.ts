 ...
 * - `1`..`PIPELINE_STEP_COUNT` = 시뮬레이션의 각 STEP. 마지막 STEP은 그림 자체는
 *   완성 상태와 같고, 여기서 수동 조작이 다시 풀린다.
 */
...
export const PIPELINE_STEPS: readonly PipelineStep[] = [
  ...
  },
  {
    title: 'P^world_scene',
    detail:
      'T_cal로 좌표계를 옮기면 로봇이 그대로 쓸 수 있는 최종 답이 됩니다. 완성 상태이므로 Master 드래그 같은 수동 조작도 다시 열립니다.',
  },
];
